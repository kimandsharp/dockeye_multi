...
c
      subroutine energy_f(atom_data,n)
      implicit none
      integer maxatmdata,maxobjdata,maxcircle
      integer num_points
c
      parameter (maxobjdata = 20000)
      parameter (maxatmdata = 20000)
      parameter (maxcircle = 500)
      parameter (num_points = 10)
c
c      real*8 atom_data(maxatmdata) ! input 
      real*8 atom_data(n) ! input 
      real*8 dsd(maxobjdata) ! output
c
      integer n1,n2,nmod
      integer i,j,k,m,n
...
c
      real*8 vp(3),v1(3),v2(3),angle,ca,sa
...
c
      ...
      dsd(ndata) = m_best
      dsd(1) = ndata
      print *,'# return data: ',ndata
      print *,dsd(1),dsd(2),dsd(3),dsd(4)
      print *,dsd(ndata),dsd(ndata-1),dsd(ndata-2),
     &     dsd(ndata-3),dsd(ndata-4)
      return
      end
c
c==========================
